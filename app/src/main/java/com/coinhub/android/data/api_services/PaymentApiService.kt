...
interface PaymentApiService {
    ...
    @POST("payment/top-up")
    suspend fun createTopUp(@Body createVnPayDto: CreateTopUpRequestDto): Response<CreateTopUpResponseDto>

    @GET("payment/top-up/{id}")
    suspend fun getTopUpById(@Path("id") id: String): Response<TopUpResponseDto>
}